...
RxTranslation.ɵfac = function RxTranslation_Factory(t) { return new (t || RxTranslation)(ɵngcc0.ɵɵinject(ɵngcc1.HttpClient), ɵngcc0.ɵɵinject(ɵngcc0.ApplicationRef)); };
RxTranslation.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: RxTranslation, factory: RxTranslation.ɵfac });
RxTranslation.ctorParameters = () => [
    { type: HttpClient },
    { type: ApplicationRef }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RxTranslation, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc1.HttpClient }, { type: ɵngcc0.ApplicationRef }]; }, null); })();
...
ComponentGuard.ɵfac = function ComponentGuard_Factory(t) { return new (t || ComponentGuard)(ɵngcc0.ɵɵinject(RX_TRANSLATE_CONFIG), ɵngcc0.ɵɵinject(ɵngcc0.Injector), ɵngcc0.ɵɵinject(CUSTOM_LOADER), ɵngcc0.ɵɵinject(ɵngcc1.HttpClient)); };
ComponentGuard.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: ComponentGuard, factory: ComponentGuard.ɵfac });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ComponentGuard, [{
        type: Injectable
    }], function () { return [{ type: RxTranslateConfig, decorators: [{
                type: Inject,
                args: [RX_TRANSLATE_CONFIG]
            }] }, { type: ɵngcc0.Injector }, { type: undefined, decorators: [{
                type: Inject,
                args: [CUSTOM_LOADER]
...
RxTranslateDirective.ɵfac = function RxTranslateDirective_Factory(t) { return new (t || RxTranslateDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Injector), ɵngcc0.ɵɵdirectiveInject(RX_TRANSLATE_CONFIG), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.ActivatedRoute), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.HttpClient)); };
RxTranslateDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: RxTranslateDirective, selectors: [["", "rxTranslate", ""]], inputs: { translate: ["rxTranslate", "translate"] } });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RxTranslateDirective, [{
        type: Directive,
        args: [{
                selector: '[rxTranslate]'
            }]
    }], function () { return [{ type: ɵngcc0.ViewContainerRef }, { type: ɵngcc0.TemplateRef }, { type: ɵngcc0.Injector }, { type: RxTranslateConfig, decorators: [{
                type: Inject,
                args: [RX_TRANSLATE_CONFIG]
            }] }, { type: ɵngcc2.ActivatedRoute }, { type: ɵngcc1.HttpClient }]; }, { translate: [{
            type: Input,
            args: ['rxTranslate']
        }] }); })();
...
TranslationResolver.ɵfac = function TranslationResolver_Factory(t) { return new (t || TranslationResolver)(ɵngcc0.ɵɵinject(ɵngcc1.HttpClient)); };
TranslationResolver.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: TranslationResolver, factory: TranslationResolver.ɵfac });
TranslationResolver.ctorParameters = () => [
    { type: HttpClient }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TranslationResolver, [{
        type: Injectable
...
RxTranslatePipe.ɵfac = function RxTranslatePipe_Factory(t) { return new (t || RxTranslatePipe)(); };
RxTranslatePipe.ɵpipe = /*@__PURE__*/ ɵngcc0.ɵɵdefinePipe({ name: "rxTranslate", type: RxTranslatePipe, pure: true });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RxTranslatePipe, [{
        type: Pipe,
        args: [{ name: 'rxTranslate' }]
    }], null, null); })();
...
RxTranslateModule.ɵfac = function RxTranslateModule_Factory(t) { return new (t || RxTranslateModule)(ɵngcc0.ɵɵinject(RX_TRANSLATE_CONFIG), ɵngcc0.ɵɵinject(ɵngcc1.HttpClient)); };
RxTranslateModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: RxTranslateModule });
RxTranslateModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [ComponentGuard, RxTranslation, TranslationResolver, { provide: CUSTOM_LOADER, useValue: null }], imports: [RouterModule, HttpClientModule] });
RxTranslateModule.ctorParameters = () => [
    { type: RxTranslateConfig, decorators: [{ type: Inject, args: [RX_TRANSLATE_CONFIG,] }] },
    { type: HttpClient }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RxTranslateModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(RxTranslateModule, { declarations: function () { return [RxTranslateDirective, RxTranslatePipe]; }, imports: function () { return [RouterModule, HttpClientModule]; }, exports: function () { return [RxTranslateDirective, RxTranslatePipe]; } }); })();

class RxTranslateSanitizeModule {
}
RxTranslateSanitizeModule.ɵfac = function RxTranslateSanitizeModule_Factory(t) { return new (t || RxTranslateSanitizeModule)(); };
RxTranslateSanitizeModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: RxTranslateSanitizeModule });
RxTranslateSanitizeModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [CurrencyPipe, DatePipe, DecimalPipe, I18nPluralPipe, I18nSelectPipe, LowerCasePipe, PercentPipe, SlicePipe, TitleCasePipe, UpperCasePipe], imports: [CommonModule] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RxTranslateSanitizeModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(RxTranslateSanitizeModule, { imports: function () { return [CommonModule]; } }); })();
